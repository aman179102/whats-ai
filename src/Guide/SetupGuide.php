...
class SetupGuide
{
    public static function getWhatsAppGuides(): array
    {
        return [
            ...
            'webscraper' => [
                'title' => 'WhatsApp Web Bridge (Easiest) ✅',
                'warning' => false,
                'steps' => [
                    [
                        'step' => 1,
                        'title' => 'Install Node.js',
                        'description' => 'Download and install Node.js from nodejs.org (LTS version recommended). This is a one-time setup.',
                        'link' => 'https://nodejs.org/',
                    ],
                    [
                        'step' => 2,
                        'title' => 'Open Terminal in bridge/ Folder',
                        'description' => 'Navigate to the "bridge" folder inside the project. On Windows: right-click → "Open in Terminal". On Mac/Linux: open terminal and type: cd path/to/bridge',
                    ],
                    [
                        'step' => 3,
                        'title' => 'Run the Setup Command',
                        'description' => 'Type: npm install (this downloads WhatsApp Web library — takes ~30 seconds). Then type: npm start (starts the bridge). You will see a QR code in the terminal.',
                    ],
                    [
                        'step' => 4,
                        'title' => 'Scan QR Code with WhatsApp',
                        'description' => 'Open WhatsApp on your phone → Tap the 3 dots (menu) → Linked Devices → Link a Device → Scan the QR code from the terminal. Also visible on the Dashboard.',
                    ],
                    [
                        'step' => 5,
                        'title' => 'Done! ✅',
                        'description' => 'WhatsApp is now connected! Go to Dashboard to send messages. The bridge will stay connected as long as the terminal is open.',
                    ],
                    [
                        'step' => 6,
                        'title' => '⚠️ Risk Warning',
                        'description' => 'This is an unofficial method. WhatsApp may ban your account for using automated tools. Use only for educational/personal purposes at your own risk.',
                    ],
                ],
            ],
        ];
